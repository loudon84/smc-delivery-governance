...
REQ=["Change ID","Surface","Framework","Layout","Component Map","State Ownership","Interaction States","Design System","Responsive","Visual Verification"]
def validate(p):
 required=list(REQ)
 # Explicit justified N/A is allowed.
 return validate_table(p,"Frontend Design Intent",required,"FRONTEND_PREPLAN")
val=validate
def main():
