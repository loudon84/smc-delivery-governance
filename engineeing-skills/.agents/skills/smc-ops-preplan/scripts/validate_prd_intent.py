...
REQ=["Change ID","Deployment Impact","Compatibility","Environment/Config","Health","Migration Order","Rollback","Live Verification"]
def validate(p):
 required=list(REQ)
 # Explicit justified N/A is allowed.
 return validate_table(p,"Ops Design Intent",required,"OPS_PREPLAN")
val=validate
def main():
